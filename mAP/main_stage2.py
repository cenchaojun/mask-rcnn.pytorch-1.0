...
for txt_file in ground_truth_files_list:
  ...
  if not os.path.exists('predicted_stage2/' + file_id + ".txt"):
    error_msg = "Error. File not found: predicted_stage2/" + file_id + ".txt\n"
...
predicted_files_list = glob.glob('predicted_stage2/*.txt')
...
with open(results_files_path + "/results.txt", 'w') as results_file:
  ...
  for class_index, class_name in enumerate(gt_classes):
    ...
    for jdx, _ in enumerate(fp):
        if _ >= 2443 * 0.2:  # 1638 * 0.2 = 327.6, 371 * 0.2 = 74.2, 1876 * 0.2 = 375.2, 1876*4*0.2=1500.8
            # print("%.3f" % (fp[jdx] / 2443))
