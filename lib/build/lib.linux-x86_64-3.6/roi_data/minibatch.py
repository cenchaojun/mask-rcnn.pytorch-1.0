...
def get_minibatch(roidb):
    ...
    # 'data', 'rois', 'labels_int32', 'bbox_targets', 'bbox_inside_weights', 'bbox_outside_weights'
    ...
    # blobs['has_mask'] = [np.array([e['has_mask']], dtype=np.uint8) for e in roidb]  # LJY
