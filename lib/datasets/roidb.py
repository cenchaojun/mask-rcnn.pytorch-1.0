...
def combined_roidb_for_training(dataset_names, proposal_files):
    ...
    def get_roidb(dataset_name, proposal_file):
        # pdb.set_trace()
        if dataset_name == 'hospital_train':
            from .hospital_dataset import JsonDataset
        elif dataset_name == 'quality_control_train':
            from .quality_dataset import JsonDataset
        elif dataset_name == 'PB_train':
            from .PB_dataset import JsonDataset
        ...
        if cfg.TRAIN.USE_FLIPPED:
            ...
            extend_with_flipped_entries(roidb, ds) # 24232 -> 48464
    ...
    # pdb.set_trace()
    # LJY: use all the negative images
    if cfg.DROP_NEGATIVE_IMAGES:
        roidb = filter_for_training(roidb)  # 48464 -> 33810
